...
public class MainClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        FabricLoader.getInstance().getModContainer(Main.MOD_ID).ifPresent(container -> {
            ...
            //ResourceManagerHelper.registerBuiltinResourcePack(asId("secretlife"), container, Text.translatable("Secret Life Resourcepack"), ResourcePackActivationType.NORMAL);
        });
    }
}
