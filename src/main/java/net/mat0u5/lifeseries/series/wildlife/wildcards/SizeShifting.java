...
public class SizeShifting extends Wildcard {
    /*
    TODO Config, Wild card starting automatically,.....
     */
    ...
    public float getPlayerSize(ServerPlayerEntity player) {
    ...
    public void setPlayerSize(ServerPlayerEntity player, double size) {
